...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(123/10);
        System.out.println(123%10);  // 나머지를 구할 수 있다.
        ...
        System.out.println(1.23/10.0);
        System.out.println(1.23%1.0);  // 나머지를 구할 수 있다. 그러나 오차 있을수는 있다.
        ...
        System.out.println('a'+'b');   // a가 97 b가 98로 정해져 있음. 참고로 A:65
        System.out.println('a'-'b');
        System.out.println('a'*'b');
        System.out.println('a'/'b');
        System.out.println('a'%'b');   // 나머지를 구할 수 있다.
        ...
        // 결국 지금까지의 연산은 숫자끼리의 연산을 본 것이고, 숫자(정수 혹은 실수) 형태의 값은
